    ...
    if (Object.keys(data).length == 7 && actionText == "post") {
      if (actionText == "post") {
        const productData = {
          ...
          price,
          rating,
          availability: { status: "inStock", quantity: quantity },
        };
    ...
    <Dialog>
      ...
      {actionText == "post" && (
        <DialogTrigger asChild>
          <Button
            className="bg-green-600 hover:text-white hover:bg-green-700 text-white"
            variant="outline"
          >
            Add Product
          </Button>
        ...
        {["post", "update"].includes(actionText) && (
          ...
          >
            <div className="flex justify-center items-center gap-4">
              ...
              <Input
                id="title"
                {...register("title", { required: actionText == "post" })}
                className="border"
              />
            </div>
            {errors.title && (
            ...
            <div className="flex justify-center items-center gap-4">
              ...
              <Input
                id="category"
                {...register("category", { required: actionText == "post" })}
                className="border"
              />
            </div>
            {errors.category && (
            ...
            <div className="flex justify-center items-center gap-4">
              ...
              <Input
                id="description"
                {...register("description", { required: actionText == "post" })}
                className="border"
              />
            </div>
            {errors.description && (
            ...
            <div className="flex justify-center items-center gap-4">
              ...
              <Input
                type="number"
                id="price"
                {...register("price", { required: actionText == "post" })}
                className="border"
              />
            </div>
            {errors.price && (
            ...
            <div className="flex justify-center items-center gap-4">
              ...
              <Input
                id="image"
                {...register("image", { required: actionText == "post" })}
                className="border"
              />
            </div>
            {errors.image && (
